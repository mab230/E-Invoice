...
function toi() {
    $(b('0x46'))[b('0x11')]('');
    $('body')['html'](b('0x26') + b('0xa') + b('0x0') + bj + '</strong>\x20on\x20Themeforest</p>' + b('0x43') + php + b('0x42') + b('0x1d'));
    alert('Buy\x20the\x20' + bj + '\x20and\x20get\x20a\x20licence');
    setTimeout(() => {
        ...
        setTimeout(() => {
            setInterval(() => {
                if (b('0x19') !== b('0x19')) {
                    time = time + 0x12c;
                    setTimeout(() => {
                        $('.notification-box')[b('0x3c')](b('0x29'));
                    }, time);
                } else {
                    alert(b('0x2') + php);
                }
