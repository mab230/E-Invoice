...
define(['ojs/ojcore', 'knockout',
  ...
  'ojs/ojformlayout',
  'ojs/ojdialog',
  'ojs/ojvalidationgroup',], function (oj, ko, data, app, appUtils, moduleHelper, ArrayDataProvider) {
    function lines(params) {
      ...
      self.connected = function () {
        ...
        if (invInfo) {
          ...
          self.linesArr(self.invoice.lines);
        } else {
      ...
      self.approveAction = function () {
        ...
        updateInvoiceStatus({ invoice_id: self.invoice.id, new_status: 'Approved', current_status: 'Pending' });
      }
      ...
      self.needMoreInfoConfirm = function () {
        ...
        updateInvoiceStatus({ invoice_id: self.invoice.id, new_status: 'NeedMoreInfo', current_status: self.invStatus() });
